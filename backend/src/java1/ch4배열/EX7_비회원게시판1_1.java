		...
		while(true) {
			...
			if(btn==1) {
				...
				for( int i = 0 ; i<boardlist.length ; i++) {
					if( i == btn2 ) {
						System.out.println("작성자	: " + boardlist[i][2] );
						System.out.println("제 목	: " + boardlist[i][0] );
						System.out.println("내 용	: " + boardlist[i][1] );
						System.out.println("=======================================");
